    ...
    return (
        <>
            <Swiper
                ...
                className="mySwiper">
                <SwiperSlide>
                    <img src="https://res.cloudinary.com/ashraful-islam/image/upload/v1652967873/Assesment/Bannar-1_cjrgua.jpg" alt="Bannar Image" className="relative lg:min-h-[85vh] min-h-[70vh]" />
                ...
                <SwiperSlide>
                    <img src="https://res.cloudinary.com/ashraful-islam/image/upload/v1652967873/Assesment/Bannar-2_kqy9ou.jpg" alt="Bannar Image" className="relative lg:min-h-[85vh] min-h-[70vh]" />
                    <div className="overlay"></div>
                    <div className="absolute text-white top-[15%] left-[15%] text-left">
                        <p className="text-2xl text-orange-500 font-bold mb-6 lg:block md:block hidden">We are the best</p>
                ...
                <SwiperSlide>
                    <img src="https://res.cloudinary.com/ashraful-islam/image/upload/v1652967872/Assesment/Bannar-3_g9et0z.jpg" alt="Bannar Image" className="relative lg:min-h-[85vh] min-h-[70vh]" />
                    <div className="overlay"></div>
                    <div className="absolute text-white top-[15%] left-[15%] text-left">
                        <p className="text-2xl text-orange-500 font-bold mb-6 lg:block md:block hidden">We are the best</p>
                ...
                <SwiperSlide>
                    <img src="https://res.cloudinary.com/ashraful-islam/image/upload/v1652967874/Assesment/Bannar-4_lpzwnx.png" alt="Bannar Image" className="relative lg:min-h-[85vh] min-h-[70vh]" />
                    <div className="overlay"></div>
                    <div className="absolute text-white top-[15%] left-[15%] text-left">
                        <p className="text-2xl text-orange-500 font-bold mb-6 lg:block md:block hidden">We are the best</p>
